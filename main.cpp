...
double chord_method(ostream& res_out){
    ...
    cout << "N = " << N << endl;
    res_out << "|" << "Хорд            " << "|" << setw(16) << x1 << "|" << setw(12) << f(x1) << "|" << " [" << setw(4) << a << ", " << setw(4) << b << "] " << "|";
    res_out << setw(5) << x0 << "|" << setw(7) << N << "|" << setw(5) << M << "|" << setw(5) << m<< "|" << setw(5) << q << "|" << endl;
    res_out << "+----------------+----------------+------------+--------------+-----+-------+-----+-----+-----+" << endl;
    return x1;
...
double bisect_method(ostream& res_out){
    ...
    cout << "x = " << ksi << endl;
    cout << "N = " << N << endl;
    res_out << "|" << "Бисекции        " << "|" << setw(16) << ksi << "|" << setw(12) << f(ksi) << "|" << " [" << setw(4) << a << ", " << setw(4) << b << "] " << "|";
    res_out << setw(5) << x0 << "|" << setw(7) << N << "|" << setw(5) << M << "|" << setw(5) << m<< "|" << setw(5) << q << "|" << endl;
    res_out << "+----------------+----------------+------------+--------------+-----+-------+-----+-----+-----+" << endl;
    return ksi;
...
double newton_method(ostream& res_out){
    ...
    cout << "N = " << N << endl;
    res_out << "|" << "Ньютона         " << "|" << setw(16) << x1 << "|" << setw(12) << f(x1) << "|" << " [" << setw(4) << a << ", " << setw(4) << b << "] " << "|";
    res_out << setw(5) << x0 << "|" << setw(7) << N << "|" << setw(5) << M << "|" << setw(5) << m<< "|" << setw(5) << q << "|" << endl;
    res_out << "+----------------+----------------+------------+--------------+-----+-------+-----+-----+-----+" << endl;
    return x1;
...
double etken_method(ostream& res_out){
    ...
    cout << "N = " << N << endl;
    res_out << "|" << "Еткена          " << "|" << setw(16) << x2 << "|" << setw(12) << f(x2) << "|" << " [" << setw(4) << a << ", " << setw(4) << b << "] " << "|";
    res_out << setw(5) << x0 << "|" << setw(7) << N << "|" << setw(5) << M << "|" << setw(5) << m<< "|" << setw(5) << q << "|" << endl;
    res_out << "+----------------+----------------+------------+--------------+-----+-------+-----+-----+-----+" << endl;
    return x1;
